...
@ManagedBean
@ViewScoped
public class OrganizationalandProfessionalWellbeingController {
     ...
     */
    public OrganizationalandProfessionalWellbeingController() {
    ...
    public void init(){
        ...
        for(Questions q : questionsList){
            if(q.getCategory().getCategoryname().equals("organizational")){
    ...
    public void evaluateAnswer(){
        ...
        if(this.getAnswer() == null){
            ...
            timer = 20;
            RequestContext.getCurrentInstance().update("ques4");RequestContext.getCurrentInstance().update("opt4");
        }
