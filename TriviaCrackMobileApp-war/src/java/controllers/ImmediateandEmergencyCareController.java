...
@ManagedBean
@ViewScoped
public class ImmediateandEmergencyCareController {
     ...
     */
    public ImmediateandEmergencyCareController() {
    ...
    public void init(){
        ...
        for(Questions q : questionsList){
            if(q.getCategory().getCategoryname().equals("immediate")){
    ...
    public void evaluateAnswer(){
        ...
        if(this.getAnswer() == null){
            ...
            timer = 20;
            RequestContext.getCurrentInstance().update("ques3");RequestContext.getCurrentInstance().update("opt3");
        }
