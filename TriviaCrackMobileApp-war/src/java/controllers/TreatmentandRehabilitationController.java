...
@ManagedBean
@ViewScoped
public class TreatmentandRehabilitationController {
     ...
     */
    public TreatmentandRehabilitationController() {
    ...
    public void init(){
        ...
        for(Questions q : questionsList){
            if(q.getCategory().getCategoryname().equals("treatment")){
    ...
    public void evaluateAnswer(){
        ...
        if(this.getAnswer() == null){
            ...
            timer = 20;
            RequestContext.getCurrentInstance().update("ques5");RequestContext.getCurrentInstance().update("opt5");
        }
